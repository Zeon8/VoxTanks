...
namespace Netcode.Transports.PhotonRealtime
{
    ...
    public partial class PhotonRealtimeTransport2 : NetworkTransport, IOnEventCallback
    {
        ...
        /// <summary>
        /// Gets or sets the max players could join to room.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the room options to create or join.
        /// </summary>
